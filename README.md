> **Helmsmen** — a personal fork of [Terax](https://github.com/crynta/terax-ai) for running CLI coding agents in parallel: one task = one git worktree, hook-driven status, one cross-project approval queue. Planning docs: [PRD.md](PRD.md), [CONTEXT.md](CONTEXT.md). Tracks upstream; see issue #2.
